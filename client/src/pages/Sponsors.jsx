...
const Sponsors = () => {
  ...
  return (
    <div className="p-1 md:p-4 space-y-6 font-sans text-slate-800">
      ...
      <div className="flex gap-2 p-1 bg-gray-300/10 border border-slate-100 shadow-sm rounded-xl w-fit shrink-0">
        {/* bg-white px-4 py-3 rounded-2xl border border-slate-100 shadow-sm  flex items-center gap-3 transition duration-150 */}
        <button
