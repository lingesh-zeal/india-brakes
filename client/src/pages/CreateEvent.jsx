...
//   const handleSubmit = async (e, draftStatus = null) => {
//     e.preventDefault();
...
//       data.append("status_id", draftStatus || form.status_id);
...
//       data.append(
//         "speakers",
//         JSON.stringify(form.speakers.map(s => { const o = {...s}; delete o.image; return o; })),
//       );
...
//       data.append(
//         "sponsors",
//         JSON.stringify(form.sponsors.map(s => { const o = {...s}; delete o.logo; return o; })),
//       );
...
//       <div className="w-full max-w-5xl h-auto min-h-[85vh] bg-white rounded-3xl shadow-lg overflow-hidden flex flex-col border border-slate-200">
